 ...
 * @param {[object]} options.connectionOption if set, will be passed to the broke.Connection
...
class Emitter extends EventEmitter {
  constructor(options) {
    ...
    this.connection = this._options.connection || new broker.Connection(Object.assign({
      uri: this._options.uri,
    }, this._options.connectionOption));
